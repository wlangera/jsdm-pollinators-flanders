...
> If you include species that are absent in certain habitat types. The parameter estimates of the fixed effects will blow up. This was not a problem when we were interested in the random effects. But will be now since we are interested in the interactoin terms of environmental and trait variables.
